...
i686-w64-mingw32-g++ justsquares.cpp libs/PerlinNoise.cpp libs/enet/*.c -static-libgcc -static-libstdc++ -std=c++14 -lX11 -lopengl32 -lpthread -lgdi32 -lgdiplus -lstdc++fs -lwinmm -o build/justsquares.exe -lwsock32 -lws2_32 -posix -static
